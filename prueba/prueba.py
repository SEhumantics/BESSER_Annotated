...
from besser.generators.spreadsheet import SpreadSheetGenerator
...
written_by: Property = Property(name="writtenBy", type=author, multiplicity=Multiplicity(0, 1))
...
# Code Generation
sheet = SpreadSheetGenerator(model=library_model)
sheet.generate()
